...
<form class="layui-form" style="width:80%;">
    ...
    <!--设置指派人id-->
    <input type="hidden" name="" id="assignManId" value="${(saleChance.assignMan)!}">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="changeSource"
                   id="changeSource" value="${(saleChance.changeSource)!}" placeholder="请输入机会来源">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
    ...
    <div class="layui-form-item layui-row layui-col-xs12">
        ...
        <div class="layui-input-block">
            <input type="text" class="layui-input" name="cgji" value="${(saleChance.cgji)!}"
                   placeholder="请输入成功几率">
        </div>
    </div>
    <div class="layui-form-item layui-row layui-col-xs12">
