				...
				<form class="layui-form" >
					...
					<div class="layui-form-item layui-row">
						...
						<div class="layui-col-xs6">
							...
							<div class="layui-input-block">
								<input type="text" class="layui-input"
									   name="changeSource" id="changeSource" value="${(saleChance.changeSource)!}" readonly="readonly">
							</div>
						</div>
					</div>
					...
					<div class="layui-form-item layui-row">
						...
						<div class="layui-col-xs6">
							...
							<div class="layui-input-block">
								<input type="text" class="layui-input"
									   name="cgji" value="${(saleChance.cgji)!}"  readonly="readonly">
							</div>
						</div>
					</div>
				</form>
	...
	<#if saleChance.devResult == 0 || saleChance.devResult==1>
		<script type="text/html" id="toolbarDemo">
			<div class="layui-btn-container">
				...
				<a class="layui-btn layui-btn-normal addNews_btn layui-bg-green layui-bg-green" lay-event="success">
					<i class="layui-icon">&#xe608;</i>
					开发成功
				</a>
				<a class="layui-btn layui-btn-normal addNews_btn layui-bg-red layui-bg-red" lay-event="failed">
					<i class="layui-icon">&#xe608;</i>
					开发失败
				</a>
			</div>
