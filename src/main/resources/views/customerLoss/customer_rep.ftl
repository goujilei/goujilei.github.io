                    ...
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   name="customerName" id="customerName" value="${(customerLoss.cusName)!}"
                                   readonly="readonly">
                        </div>
                    </div>
                    <div class="layui-col-xs6">
                        ...
                        <div class="layui-input-block">
                            <input type="text" class="layui-input"
                                   name="chanceSource" id="chanceSource" value="${(customerLoss.cusNo)!}"
                                   readonly="readonly">
                        </div>
                    </div>
                </div>
...
<#if customerLoss.state==0>
    <script type="text/html" id="toolbarDemo">
        <div class="layui-btn-container">
            ...
            <a class="layui-btn layui-btn-normal " lay-event="confirm">
                <i class="layui-icon">&#xe608;</i>
                确认流失
            </a>
        </div>
